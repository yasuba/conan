...
trait LambdaKeys {
  ...
  lazy val conanConfig = settingKey[PublishLambdaConfig]("Config required to publish lambda to AWS")
  def publishLambdaConfigBuilder: PublishLambdaConfigBuilder = PublishLambdaConfigBuilder()
}
